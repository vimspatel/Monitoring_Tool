<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="omsi_client_status_nomaster.aspx.cs" Inherits="Monitoring_Tool.devread" %>
...
<head runat="server">
    ...
    <title>CarrierPoint Setup Information</title>
    <meta name="description" content="CarrierPoint Setup Information" />
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="right-panel" class="right-panel">
            ...
            <asp:Label ID="lbl_POST_URL" runat="server"></asp:Label><br />
            <asp:Label ID="lbl_JDBC_URL" runat="server"></asp:Label><br />
            <asp:Label ID="lbl_CPClientLine" runat="server" Text="CPClientLines"></asp:Label><br />
            <asp:Label ID="lblomsi_clinetlog" runat="server" Text="Total log entry"></asp:Label><br />
            <asp:Label ID="lblgetdate" runat="server" Text="Today's Date"></asp:Label><br />
            <asp:Label ID="lblgetlogdate" runat="server" Text="Log Date"></asp:Label><br />

            <asp:Label ID="lbl_cp_status" runat="server"></asp:Label><br />

            <asp:Label ID="lbl_copystatus" runat="server"></asp:Label><br />
